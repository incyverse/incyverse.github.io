...
can re-build the site in many different ways, but the most common way is to run `jekyll serve`, which launches a web
...
representing the format used in th file. After that, include the necessary front matter. Take a look at the source for
